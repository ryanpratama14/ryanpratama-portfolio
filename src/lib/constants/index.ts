...
export const TECH_STACKS: TechStack = {
  ...
  librariesFrameworks: [
    ...
    { label: "Motion", icon: ICONS.framerMotion },
  ...
  aiTools: [
    { label: "Claude Code", icon: ICONS.claudeCode },
    { label: "Codex", icon: ICONS.openai },
    { label: "Cursor", icon: ICONS.cursor },
    { label: "GitHub Copilot", icon: ICONS.githubCopilot },
  ],
