...
export const ru: Dictionary = {
  PERSONAL_DATA: {
    ...
    summary:
      "Software Engineer с более чем 2-летним опытом разработки веб и мобильных приложений с использованием Next.js и React Native. Обладаю навыками разработки высококачественных решений, адаптированных к требованиям клиентов, и стремится быть в курсе тенденций отрасли и новейших технологий.",
    softwareEngineer: "Software Engineer",
    contactMe: "Свяжиться",
    learnMore: "Узнать больше",
    age: "23 г.",
    about:
      "В сентябре 2022 года я присоединился к бесплатному курсу программирования, который вел мой индонезийский друг в его квартире в Казани, Россия. Вместе с другими ребятами мы изучили основы JavaScript и в январе 2023 года сформировали стартап по производству программного обеспечения под названием «faoTech». По мере того, как я развивал свои навыки, я обнаружил в себе страсть к full-stack разработке и решил специализироваться в этой области.",
  },
