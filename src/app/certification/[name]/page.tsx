...
import type { Lang, SearchParamsLang } from "@/types";
import type { Metadata } from "next";
import { redirect } from "next/navigation";
import { Fragment } from "react";

type Props = SearchParamsLang & { params: { lang: Lang; name: string } };
...
export default function CertificationPage({ params: { name }, searchParams: { lang } }: Props) {
  const data = CERTIFICATIONS.find((e) => e.name === name);
