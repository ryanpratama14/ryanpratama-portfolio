...
export default function Resume({ title }: Props) {
  return (
    <a href="/resume.pdf" target="_blank" rel="noreferrer" type="button" className="outline-none flex gap-3 h-full items-center group select-none">
      <Iconify icon="pepicons-pencil:cv-circle" className="text-3xl md:text-4xl rotate-[16deg] group-hover:rotate-0 group-hover:scale-110 animate" />
