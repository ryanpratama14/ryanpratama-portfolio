  ...
  const Card = () => {
    return (
      <section className="flex items-center text-left">
        ...
        <section className="pl-2.5 md:pl-3">
          <Link target="_blank" rel="noreferrer noopener" href={e.href} className="line-clamp-1 w-fit flex items-center gap-1 translate-x-[0.085rem]">
    ...
    return (
      <AccordionItem value={e.label}>
        ...
        <AccordionContent className="space-y-0.5 text-pretty">
          {e.about ? (
            <Text tag="p" as="contentSmall" className="whitespace-pre-line">
              {e.about}
            </Text>
          ) : null}
