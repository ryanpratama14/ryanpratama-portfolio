          ...
          return (
            <SwiperSlide key={e.title}>
              <section className="aspect-[4/5] relative group">
                <section className="absolute left-0 top-0 size-full opacity-0 group-hover:opacity-100 bg-black/80 animate flex flex-col items-center justify-center gap-2 px-4 lg:px-8">
